...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    [SerializeField] private float _manualXPosition1 = 450f;
    [SerializeField] private float _manualXPosition2 = 1350f;
    ...
    private void SetPagePositions() {
        ...
        _pagePositions.Add(new Vector2(-_manualXPosition1, 0));
        _pagePositions.Add(new Vector2(-_manualXPosition2, 0));
        return;
